...
def visualize_train(predicted_point, epoch, iteration, batch_size, model_name):
	res_dir = '/media/tree/backup/projects/new_work/result'
	vis_dir = os.path.join(res_dir, model_name, 'vis')
	...
	cv2.imwrite(os.path.join(vis_dir, '{:0>7}_{:0>2}.png'.format(current, epoch)), pred_rendering)

def get_path(model_name, cat):

	vis_dir = '/media/tree/backup/projects/new_work/vis'
	image_dir = '/media/tree/backup/projects/new_work/vis/image'
	gt_point_dir = '/media/tree/backup/projects/new_work/vis/ground_truth_point'
	gt_rendering_dir = '/media/tree/backup/projects/new_work/vis/groud_truth_rendring'
